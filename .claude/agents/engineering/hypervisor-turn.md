...
- **A new crate is a workspace act** — a new crate under `crates/` or `tools/` MUST carry `[lints] workspace = true`, or it sits silently outside the lint policy while every gate stays green.
